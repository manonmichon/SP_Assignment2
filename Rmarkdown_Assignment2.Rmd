...
The RMSEP function displays again the error of the model for each number of components The fact that the error here was the lowest for 2 components confirms that this was chosen correctly.
