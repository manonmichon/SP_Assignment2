...
Before the model can be constructed, data needs to be obtained. The data used in this model is obtained from wikidata. Physicochemical properties such as molecular descriptors will be obtained from the github of the rcdk package. 
...
Alkanes can also be requested using another unit such as 'Celcius' or 'Fahrenheit'. However, since 'Kelvin' is the official scientific notation and a lot of alkanes will only have boiling point registered in 'Kelvin', it is recommended to keep using 'Kelvin'.
